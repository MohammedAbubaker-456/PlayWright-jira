...
test.describe(" testing dynamic code rca", () => {
  test("54321 - testing dynamic code rca", async ({ page }) => {
    test.setTimeout(30000);
    const loginPage = new LoginPage(page);

    await loginPage.loginToApplication("john@abc.com", "oracle");

    await page.waitForLoadState("networkidle");


    await page.locator("//span[@class='fa fa fa-file-plus']").click();
    ...
    // await page
    //   .locator("button:has-text('Create RCA & route to Triage')")
    //   .click();
